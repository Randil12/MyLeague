...
export default function TeamOverview({patch,roster,revision}:{patch:string;roster:string[];revision:number}) {
  ...
  return <section className="panel"><div className="panel-head"><div><h2>Tableau de suivi des cinq joueurs</h2><p>Performances individuelles SoloQ sur le patch sélectionné.</p></div></div>
